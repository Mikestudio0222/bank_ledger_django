"""
Django settings for bank_ledger project.
"""
...
WSGI_APPLICATION = 'bank_ledger.wsgi.application'
...
if DB_ENGINE == 'mysql':
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': config('DB_NAME', default='bank_ledger'),
...
SESSION_COOKIE_AGE = 7200  # 2小时无操作自动退出
